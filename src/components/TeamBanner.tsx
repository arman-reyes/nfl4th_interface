...
export function TeamBanner({ team, season, plays, onChangeTeam }: Props) {
  ...
  return (
    <div className="sticky top-0 z-20 shadow-sm">
      <div style={surface} className="mx-auto flex max-w-full items-center gap-3 px-3 py-2.5 sm:px-6 sm:py-3">
      ...
      <div aria-hidden className="h-1" style={{ background: team.team_color2 }} />
    </div>
  )
}
